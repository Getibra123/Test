...
public class Constants {
	...
	public static final int ALPHA_DIAMETER = 700;
	...
	public static Vector[] BALL_VEL_VARIATIONS() {
		return 	new Vector[] {
	...
	public static Point[] REPL_SOURCE() {
		return new Point[] {new Point( 25000, 19750 ) , new Point( 37500 , 19750 ), new Point( 12500, 19750 )};
	}
	...
	public static final Color STURDY_COLOR1 = new Color(160, 82, 45);
	public static final Color STURDY_COLOR2 = new Color(123, 63, 0);
	public static final Color STURDY_COLOR3 = new Color(92, 64, 51);
	
	public static final Color POWERUP_BLOCK_COLOR = new Color(215, 0, 64);
	...
	public static final Color NORMAL_BLOCK_COLOR = new Color(128, 128, 128);
	//public static final Color BLOCK_COLOR = new Color(0x80,0x00,0xff);
	
	public static final Color REPLICATOR_BLOCK_COLOR = new Color(100, 149, 237);
